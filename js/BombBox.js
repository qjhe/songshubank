...
BombBox.prototype.create = function() {
    var btnHtml = "";
    if (this.settings.btn) {
        btnHtml = "<div class='oper-wrap'><p class='b-success'><span>" + this.settings.confiTxt + "：</span><input type='button' value='" + this.settings.confiBtnTxt + "'></p> <p class='b-failed'><span>" + this.settings.cancelTxt + "：</span><input type='button' value='" + this.settings.cancelBtnTxt + "'></p></div></div>"
    }
